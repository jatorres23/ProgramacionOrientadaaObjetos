class Caida_Libre_I{
		...
		double vel_ini= Double.parseDouble(vo);//Se asigna a la variable vel_ini como Real; analiza la cadena vo y nos devuelve un valor real.
		...
		double pos_ini= Double.parseDouble(so);//Se asigna a la variable pos_ini como Real; analiza la cadena so y nos devuelve un valor real.
		double co=0.5;
		double ace=-9.81;
